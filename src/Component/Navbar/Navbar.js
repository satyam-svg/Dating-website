    ...
    <>
        ...
        <div className="nav-bar">
            ...
            <div className="menu">
                ...
                <li><Link to="/">Home</Link></li>               <li><Link to="/members">Members</Link></li>               <li><Link to="works">How it Works</Link></li>               <li><Link to="story">Stories</Link></li>               <li><Link href="#">Login</Link></li>               <li><Link to="/signup">Sign Up</Link></li>
                </ul>
            </div>
